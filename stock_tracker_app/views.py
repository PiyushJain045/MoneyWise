...
# NEWS_API = "08bb3ef46333428cb3f33856fa81503a"
FINNHUB_API_KEY = "cvvso19r01qod00lvklgcvvso19r01qod00lvkm0"

# twilio api details
# FROM lightning
# account_sid = "AC3a5ddae71bb95c520993d1456fb478be"
# auth_token = "e2f610d39e7f34ecf050bb936cff2c3e"
# phone = "+12565488007"

#from piyushjain5955
account_sid = 'AC1cab3091d90f13c1bf7bca74b90d653b'
auth_token = 'f76bef05714bbd202188df223ffef9d9'
phone = '+18653265031'

# account_sid = 'AC4cc950f7676f1005506a4b1c668e162c'
# auth_token = '98539a659af971718be4f50174813d67'
...
class st_stocknews(View):
    ...
    def post(self, request):
        ...
        phone_number = profile.phone if profile else "Not Available"
        print(phone_number)
        ...
        for stock in user_stocks:
            ...
            try:
                ...
                if diff_percent <= 0 or diff_percent >= 0:
                    ...
                    #                 f"q={comp}&"
                    #                 f"country=us&"  # You can change 'us' to your preferred country code
                    #                 f"apiKey={NEWS_API}"
                    #                 )
                    response2 = requests.get(
                    ...
                    news_data.append({"its_holiday": its_holiday,
                                      "company_name": comp,
                                      "source": data2[0]['source'],
                                       "news1":{
                                           "title":data2[1]['headline'],
                                           "content":data2[1]['summary'],
                                           "url":data2[1]['url']
                                       },
                                        "news2": {
                                            "title": data2[2]["headline"],
                                            "content": data2[2]["summary"],
                                            "url": data2[2]["url"]
                                        },
                                    })
                    print("******************************************************************************************************")
                    ...
                    if its_holiday:
                        ...
                        text = f'''
                            ...
                            Headline1: {data2[1]['headline']}
                            Headline2: {data2[2]["headline"]}
                        '''

                    client = Client(account_sid, auth_token)
                    message = client.messages.create(
                            messaging_service_sid='MGf5bd3c891570d3c982fd766bf0cd9f43',
                            body=text,
                            to=f'+919075050300'
                        )
